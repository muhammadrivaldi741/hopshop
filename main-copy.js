    ...
    fetch(`https://dummyjson.com/products/${productId}`)
        ...
        .then(product => {
            ...
            buttonCart.addEventListener('click', function(){
                addtocart(idprod, price, image, prodname)
...
function addtocart(id, price, image, prodname){
...
if(cart.length > 0){
    ...
    const html = `
        <div class="card" data-name="" id="${cart.id}"  >
                                <img src="${cart.image}" alt="" class="cardimg">
                                <h1 class="title">${cart.name}</h1>
                                <h1 class="price">$${cart.price}</h1>
                                <div class="quantity">
                                     <button onclick="kurangitem(${cart.id})">-</button>
                                    
                                    <span>${cart.quantity}</span>
                                     <button onclick="tambahitem(${cart.id})">+</button>
